...
In the elderly population, the formation of AV fistulas can be more challenging due to vessel damage from natural and iatrogenic causes (e.g., repeated blood samples over many years), as well as slow time to maturation \cite{mcgroganArteriovenousFistulaOutcomes2015}.
Synthetic vessel grafts help form a AV fistula with a shorter maturation period, or for patients with exhausted vascular access sites \cite{akohProstheticArteriovenousGrafts2009}.
