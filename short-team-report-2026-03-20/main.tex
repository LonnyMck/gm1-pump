...
Given the project requirements and desired outputs, the most suitable, low cost design, while having sufficient control was decided to be a dual syringe pump system as shown in Figure \autoref{fig:design}.
...
\begin{equation}
    V_\text{rev} = \pi D \cdot \pi r^2 = \pi \times \qty{37}{\milli\metre} \times \pi \times (\qty{2.4}{\milli\metre})^2 = \qty{2094}{\milli\metre\cubed}
\end{equation}
