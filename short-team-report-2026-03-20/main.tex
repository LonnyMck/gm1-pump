...
\begin{table}[h]
    ...
    \begin{tabularx}{\linewidth}{>{\raggedright\arraybackslash}p{4cm} X}
        ...
        Tahmid
                      & Preliminary modelling of a peristaltic pump to view the pressure profile. Calculations and modelling of the syringe force. Research on clinical motivations. Research on software options. Typesetting the presentation and short report in \LaTeX{}. \\
